        ...
        <div ref={containerRef} className="relative bg-black min-h-[400vh]">
          ...
          >
            ...
            {product.reviews && product.reviews.length > 0 && (
              <div
                className="absolute bottom-[50%] left-6 z-50 w-[300px] md:w-[480px] bg-black/40 backdrop-blur-lg 
            ...
            {relatedProducts.length > 0 && (
              <div
                className="absolute bottom-6 left-6 z-50 w-[300px] md:w-[480px] bg-black/40 backdrop-blur-lg 
                    border border-white/20 rounded-2xl p-5 shadow-xl"
              >
                <h2 className="text-xl font-bold text-white mb-4">
                  Related Products
